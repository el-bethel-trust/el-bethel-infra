/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a534ab0ac7f25a509f29396ed44e29ba)
...
declare namespace Cloudflare {
	interface Env {
		...
		LOG_LEVEL: string;
		CALLER_ID: string;
		PRAYER_GRACE_ALLOWANCE: string;
		BIBLE_READING_GRACE_ALLOWANCE: string;
		REDIAL_GRACE_ALLOWANCE: string;
		PRAYER_SESSION_START: string;
		PRAYER_SESSION_END: string;
		BIBLE_SESSION_START: string;
		BIBLE_SESSION_END: string;
		MAINTENANCE_DURATION: string;
		DAILY_VERSE_SCHEDULER_ADMIN_PIN: string;
		BULKSMS_URL: string;
		BULKSMS_API_ID: string;
		BULKSMS_API_PASSWORD: string;
		SENTRY_DSN: string;
		BULKSMS_PROXY_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODE" | "HOSTNAME" | "LOG_LEVEL" | "CALLER_ID" | "PRAYER_GRACE_ALLOWANCE" | "BIBLE_READING_GRACE_ALLOWANCE" | "REDIAL_GRACE_ALLOWANCE" | "PRAYER_SESSION_START" | "PRAYER_SESSION_END" | "BIBLE_SESSION_START" | "BIBLE_SESSION_END" | "MAINTENANCE_DURATION" | "DAILY_VERSE_SCHEDULER_ADMIN_PIN" | "BULKSMS_URL" | "BULKSMS_API_ID" | "BULKSMS_API_PASSWORD" | "SENTRY_DSN" | "BULKSMS_PROXY_URL" | "ADMIN_CONTACT">> {}
}
